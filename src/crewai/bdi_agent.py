...
class BDIAgent(BaseAgent):
    ...
    Attributes:
            ...
            desires: List of objectives of the agent.
            desire: The current objective of the agent.
    ...
    desires: List[str] = Field(
        default=[],
        description="List of objectives of the agent.",
    )
    plans: List[Plan] = Field(
        default=[],
        description="List of plans of the agent.",
    )
    current_plan: Optional[Plan] = Field(
        default=None,
        description="Current plan of the agent.",
    )
    ...
    def execute_task(
        ...
        self._handle_plan_execution(task)
        return result
    ...
    def _handle_plan_execution(self, task: Task) -> None:
        """Handle the execution of the plan."""
        if self.current_plan:
            self.current_plan.update_current_task(task)
    ...
    def __repr__(self):
        return f"Agent(role={self.role}, desires={self.desires}, desire={self.desire}, backstory={self.backstory})"
